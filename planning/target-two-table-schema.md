...
The three-phase retry failed in FK detachment before any table drop; synthetic populated cyclic FKs work in D1. Further separate the still-unapplied migration into guard removal (0071), poem FK rewrite (0072), source FK rewrite (0073), graph drop (0074), and payload contraction (0075). This identifies the failing populated rewrite while preserving a migration-ledger entry for every committed change.
